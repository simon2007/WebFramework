package org.blue.sys.weixin.service.impl;
...
import org.blue.sys.weixin.dao.WeixinUserMapper;
import org.blue.sys.weixin.model.UserIdentification;
import org.blue.sys.weixin.model.WeixinUser;
import org.blue.sys.weixin.service.WeixinService;
import org.blue.sys.weixin.utils.OfficialWeixinHelper;
import org.blue.sys.weixin.utils.SystemInfo;
import org.blue.sys.weixin.utils.WebWeixinHelper;
import org.blue.sys.weixin.utils.WeixinHelper;
import org.blue.sys.weixin.utils.WeixinHelperManager;
import org.blue.sys.weixin.vo.UserIdentificationVo;
import org.blue.sys.weixin.vo.UserWeixinMessageVo;
import org.blue.sys.weixin.vo.WeixinButton;
...
public class WeixinServiceImpl implements WeixinService {
	...
	@Override
	public void sendTemplateMessageByUnionId(String unionId, String id, JSONObject obj) {
		String serverName = getServerName();
		try {
			OfficialWeixinHelper weixinHelper = weixinHelperManager.getOfficialWeixinHelper(serverName);
			...
			weixinHelper.sendTemplateMessage(user.getOpenId(), id, linkUrl, obj);
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	 ...
	 * @param inMsg
	 */
	private void printMessage(UserWeixinMessageVo inMsg) {
